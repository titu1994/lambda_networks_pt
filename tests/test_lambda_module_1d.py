...
def test_construction(device, dim_interdimension):
    layer = lambda_module_1d.LambdaLayer1D(64, 64, dim_k=16, m=32, heads=4, dim_interdimension=dim_interdimension)
...
def test_wrong_m(device, dim_interdimension):
    layer = lambda_module_1d.LambdaLayer1D(64, 64, dim_k=16, m=64, heads=4, dim_interdimension=dim_interdimension)
    layer = layer.to(device)
    ...
    layer = lambda_module_1d.LambdaLayer1D(64, 64, dim_k=16, m=16, heads=4, dim_interdimension=dim_interdimension)
    layer = layer.to(device)
