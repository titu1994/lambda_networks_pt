...
def test_construction(device, dim_intra_dimension):
    layer = lambda_module_1d.LambdaLayer1D(64, 64, dim_k=16, m=32, heads=4, dim_intra_dimension=dim_intra_dimension)
...
def test_wrong_m(device, dim_intra_dimension):
    layer = lambda_module_1d.LambdaLayer1D(64, 64, dim_k=16, m=64, heads=4, dim_intra_dimension=dim_intra_dimension)
    layer = layer.to(device)
    ...
    layer = lambda_module_1d.LambdaLayer1D(64, 64, dim_k=16, m=16, heads=4, dim_intra_dimension=dim_intra_dimension)
    layer = layer.to(device)
